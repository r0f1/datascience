...
[Blog post:24 Evaluation Metrics for Binary Classification (And When to Use Them) + Cheatsheet](https://neptune.ml/blog/evaluation-metrics-binary-classification)
